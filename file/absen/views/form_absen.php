...
<div class="card">
    ...
    <div class="card-body">
        <form action="admin.php?target=absen&action=input" method="post" data-parsley-validate class="form-horizontal form-label-left">
        <div class="mb-3">
            ...
            <div class="mb-3">
                <div class="col-md-6 col-sm-6 col-lg-12">
                    ...
                    <a class="btn btn-danger btn-sm" href="admin.php?target=absen">Kembali</a>
                </div>
            </div>
        </form>
    </div>
